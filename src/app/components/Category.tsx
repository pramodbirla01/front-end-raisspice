...
import { fetchCategories } from '@/store/slices/categorySlice'; // Change this import
...
const Category = () => {
  ...
  if (loading) {
    return <div className="w-full h-40 flex items-center justify-center">Loading categories...</div>;
  }
  ...
  return (
    <div ref={ref} id='category_section' className='w-full bg-gradient-to-br from-amber-50/80 to-white relative overflow-hidden'>
      ...
      <div className="w-[95%] 2xl:w-[70%] mx-auto py-16 relative z-10">
